...
export default function Cotizaciones() {
  ...
  const [contactosDisponibles, setContactosDisponibles] = useState([]); // ✅ AGREGADO
  const [cargandoContactos, setCargandoContactos] = useState(false);     // ✅ AGREGADO
  ...
  // ✅ FUNCIÓN NUEVA: Cargar contactos disponibles
